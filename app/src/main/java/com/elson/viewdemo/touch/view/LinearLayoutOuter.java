 ...
 * @Desc
 */
public class LinearLayoutOuter extends LinearLayout {

    private static final String TAG = LinearLayoutOuter.class.getSimpleName();

    public LinearLayoutOuter(Context context) {
        super(context);
    }

    public LinearLayoutOuter(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LinearLayoutOuter(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public LinearLayoutOuter(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
